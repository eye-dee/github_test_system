...
public class GitHubStatusResolverTest {
    ...
    public void setUp() throws IOException {
        ...
        failureStatus = FileUtils.readFileToString(
                new File("src/test/resources/github/github_statuses_failure_response.json"),"UTF-8"
        );

        successStatus = FileUtils.readFileToString(
                new File("src/test/resources/github/github_statuses_success_response.json"), "UTF-8"
        );
    }
